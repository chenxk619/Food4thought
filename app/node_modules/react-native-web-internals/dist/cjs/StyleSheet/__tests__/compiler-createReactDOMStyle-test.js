...
describe("compiler/createReactDOMStyle", () => {
  ...
  describe("fontFamily", () => {
    test("general case", () => {
      expect(
        (0, import_createReactDOMStyle.default)({ fontFamily: "Georgia, Times, serif" })
    ...
    test('"monospace"', () => {
      expect(
        (0, import_createReactDOMStyle.default)({ fontFamily: "monospace" })
      ).toMatchInlineSnapshot(`
        {
    ...
    test('"Noto, System"', () => {
      expect(
        (0, import_createReactDOMStyle.default)({ fontFamily: "Noto, System" })
      ).toMatchInlineSnapshot(`
        {
      ...
      `);
      expect(
        (0, import_createReactDOMStyle.default)({ font: "14px Noto, System" })
      ).toMatchInlineSnapshot(`
        {
    ...
    test('"Noto, BlinkMacSystemFont"', () => {
      expect(
        (0, import_createReactDOMStyle.default)({ fontFamily: "Noto, BlinkMacSystemFont" })
      ).toMatchInlineSnapshot(`
        {
