...
describe("StyleSheet", () => {
  ...
  describe("resolve", () => {
    ...
    test("dedupes class names and inline styles", () => {
      ...
      const [className1, inlineStyle1] = (0, import__.default)([
        styleACompiled,
        styleBCompiled,
        styleBInline
      ]);
    ...
    test("long form inline style properties take precedence over static shorthand properties", () => {
      ...
      `);
      const styles2 = import__.default.create({ test: { marginVertical: "40px" } });
    ...
    test("polyfills logical styles", () => {
      ...
      const a = import__.default.create({ x: { ...inlineA } }).x;
      const b = import__.default.create({ x: { ...inlineB } }).x;
      const c = import__.default.create({ x: { ...inlineC } }).x;
