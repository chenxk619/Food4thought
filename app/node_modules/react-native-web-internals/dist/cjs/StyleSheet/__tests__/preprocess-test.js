...
describe("StyleSheet/preprocess", () => {
  ...
  describe("preprocesses multiple textShadow styles into a single declaration", () => {
    ...
    test("textShadowColor and textShadowRadius only", () => {
      expect((0, import_preprocess.preprocess)({ textShadowColor: "red", textShadowRadius: 0 })).toEqual({});
      expect((0, import_preprocess.preprocess)({ textShadowColor: "red", textShadowRadius: 5 })).toEqual({
