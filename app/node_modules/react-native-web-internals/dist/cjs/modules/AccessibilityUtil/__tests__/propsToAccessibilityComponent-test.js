...
describe("modules/AccessibilityUtil/propsToAccessibilityComponent", () => {
  ...
  test('when "accessibilityRole" is "button"', () => {
    expect(
      (0, import_propsToAccessibilityComponent.default)({ accessibilityRole: "button" })
    ).toBeUndefined();
  });
  test('when "accessibilityRole" is "heading"', () => {
    expect((0, import_propsToAccessibilityComponent.default)({ accessibilityRole: "heading" })).toEqual(
      "h1"
    );
  });
  ...
  test('when "accessibilityRole" is "label"', () => {
    expect((0, import_propsToAccessibilityComponent.default)({ accessibilityRole: "label" })).toEqual(
      "label"
    );
  });
});
