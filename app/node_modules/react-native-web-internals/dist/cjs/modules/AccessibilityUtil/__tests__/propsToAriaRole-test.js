...
describe("modules/AccessibilityUtil/propsToAriaRole", () => {
  ...
  test('when "accessibilityRole" is a native-only value', () => {
    expect((0, import_propsToAriaRole.default)({ accessibilityRole: "none" })).toEqual("presentation");
    expect((0, import_propsToAriaRole.default)({ accessibilityRole: "imagebutton" })).toEqual(void 0);
    expect((0, import_propsToAriaRole.default)({ accessibilityRole: "label" })).toEqual(void 0);
  });
});
