...
describe("use-event", () => {
  ...
  describe("setListener()", () => {
    ...
    test("event dispatched on parent", () => {
      ...
      function Component() {
        const addClickListener = (0, import__.default)("click");
        const addClickCaptureListener = (0, import__.default)("click", { capture: true });
        React.useEffect(() => {
          addClickListener(targetRef.current, listener);
    ...
    test("listener is removed when value is null", () => {
      ...
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { off: false }));
      });
      const target = (0, import_dom_event_testing_library.createEventTarget)(targetRef.current);
      (0, import_test_utils.act)(() => {
        target.click();
      ...
      expect(listener).toBeCalledTimes(1);
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { off: true }));
      });
      listener.mockClear();
      (0, import_test_utils.act)(() => {
        target.click();
    ...
    test("listeners are specific to each event handle", () => {
      ...
      function Component() {
        ...
        const addClickCaptureListener = (0, import__.default)("click", { capture: true });
        const addClickCaptureAltListener = (0, import__.default)("click", { capture: true });
        React.useEffect(() => {
          addClickListener(targetRef.current, listener);
