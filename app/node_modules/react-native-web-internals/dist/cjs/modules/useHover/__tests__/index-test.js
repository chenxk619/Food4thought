...
(0, import_dom_event_testing_library.describeWithPointerEvent)("useHover", (hasPointerEvents) => {
  ...
  describe("contain", () => {
    ...
    const componentInit = () => {
      ...
      const Component = () => {
        ...
        (0, import__.default)(childRef, { contain: true });
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: childRef }) });
      };
  ...
  describe("onHoverStart", () => {
    ...
    const componentInit = () => {
      ...
      ref = React.createRef();
      const Component = () => {
        (0, import__.default)(ref, { onHoverStart });
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref });
      };
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
  ...
  describe("onHoverChange", () => {
    ...
    const componentInit = () => {
      ...
      ref = React.createRef();
      const Component = () => {
        (0, import__.default)(ref, { onHoverChange });
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref });
      };
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
  ...
  describe("onHoverEnd", () => {
    ...
    const componentInit = () => {
      ...
      childRef = React.createRef();
      const Component = () => {
        (0, import__.default)(ref, { onHoverEnd });
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: childRef }) });
      };
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
  ...
  describe("onHoverUpdate", () => {
    test('is called after the active pointer moves"', () => {
      ...
      const Component = () => {
        (0, import__.default)(ref, { onHoverUpdate });
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref });
      };
      (0, import_test_utils.act)(() => {
        root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
