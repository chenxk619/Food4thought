  ...
  describe("setListener()", () => {
    test("event dispatched on target", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { ref: targetRef });
      }
      act(() => {
    ...
    test("event dispatched on parent", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { ref: parentRef, children: /* @__PURE__ */ jsx("div", { ref: targetRef }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    ...
    test("event dispatched on child", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { ref: targetRef, children: /* @__PURE__ */ jsx("div", { ref: childRef }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    ...
    test("event dispatched on text node", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { ref: targetRef, children: /* @__PURE__ */ jsx("div", { ref: childRef, children: "text" }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    ...
    test("listener is removed when value is null", () => {
      ...
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, { off: false }));
      });
      const target = createEventTarget(targetRef.current);
      act(() => {
        target.click();
      ...
      expect(listener).toBeCalledTimes(1);
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, { off: true }));
      });
      listener.mockClear();
      act(() => {
        target.click();
    ...
    test("listeners can be set on multiple targets simultaneously", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { id: "parent", ref: parentRef, children: /* @__PURE__ */ jsx("div", { id: "target", ref: targetRef, children: /* @__PURE__ */ jsx("div", { ref: childRef }) }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    ...
    test("listeners are specific to each event handle", () => {
      ...
      function Component() {
        ...
        return /* @__PURE__ */ jsx("div", { id: "target", ref: targetRef, children: /* @__PURE__ */ jsx("div", { ref: childRef }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
