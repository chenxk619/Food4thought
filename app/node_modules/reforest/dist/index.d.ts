...
declare function useIndexedChildren(children: React.ReactNode): JSX.Element;
...
declare function useTreeNode(getData: () => any, dependencies?: React.DependencyList): {
    id: string;
    data: any;
    indexPathString: string;
    isPrerender: boolean;
...
export { TreeState, TreeStateStore, cleanAndSortTree, compareIndexPaths, flattenChildren, mapToChildren, parseIndexPath, sortMapByIndexPath, useIndex, useIndexedChildren, useRovingIndex, useTree, useTreeNode, useTreeState };
